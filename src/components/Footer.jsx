    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          setAboutData(response.data.data[0]); // Assuming you only need the first item
        } catch (error) {
...
<a className="mr-6 text-neutral-600 dark:text-neutral-200" href={aboutData.telegram_link}>
    <FaTelegram />
</a>
<a className="mr-6 text-neutral-600 dark:text-neutral-200" href={aboutData.youtube_link}>
<FaYoutube />
</a>
        </div>
      </div>
